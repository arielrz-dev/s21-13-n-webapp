...
export default function AuthModal() {
  ...
  return (
    <div>
      <label htmlFor="auth_modal" className="btn text-white bg-pink-600 hover:bg-pink-700">
        <FaUserLarge /> Iniciar sesión
      </label>
      ...
      <div className="modal fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="modal-box w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
          <div className="flex justify-end">
            <label htmlFor="auth_modal" className="hover:text-red-500 text-black">
