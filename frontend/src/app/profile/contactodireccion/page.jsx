  ...
  return (
    ...
    <div className="w-2/3 bg-white rounded-2xl">
      ...
      <div className=" text-gray-800 font-normal mx-10 grid grid-cols-2 gap-4">
        <h2 className="text-3xl mt-8">Dirección de envío</h2>
        <h2 className="text-3xl mt-8">Dirección de facturación</h2>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <h2 className="text-3xl mt-2">Celular</h2>
        <h2 className="text-3xl mt-2">Teléfono de contacto</h2>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <div className="col-span-2">
          <h2 className="text-3xl my-4">Referencias e indicaciones</h2>
