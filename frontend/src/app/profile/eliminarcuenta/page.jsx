...
export default function Eliminarcuenta() {
  return (
    ...
    <div className="w-2/3 bg-white rounded-2xl">
      ...
      <div className=" text-gray-800 font-normal mx-10 grid grid-cols-2 gap-4 my-6">
        <h2 className="text-3xl mt-2">Ingresar correo electrónico</h2>
        <h2 className="text-3xl mt-2">Contraseña</h2>
