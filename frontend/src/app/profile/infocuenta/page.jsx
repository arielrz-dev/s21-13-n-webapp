  ...
  return (
    ...
    <div className="w-2/3 bg-white rounded-2xl">
      ...
      <div className=" text-gray-800 font-normal mx-10 grid grid-cols-2 gap-4">
        <h2 className="text-3xl mt-8">Nombre(s)</h2>
        <h2 className="text-3xl mt-8">Apellido(s)</h2>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <h2 className="text-3xl mt-2">Correo Electrónico</h2>
        <h2 className="text-3xl mt-2">Fecha de nacimiento</h2>
        <input  type="text" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50"/>
        <input  type="date" className="h-16 border-2 border-gray-500 rounded-2xl bg-pink-50 px-8"/>
        <h2 className="text-gray-500 font-normal text-3xl my-4">Género</h2>
      </div>
      <div className="text-gray-800 font-normal mx-10 flex flex-row gap-8 ">
      <label className="flex items-center space-x-2">
          <input
            ...
            className="w-6 h-6"
          />
          <span className="text-gray-800 text-3xl">Hombre</span>
        </label>
        ...
        <label className="flex items-center space-x-2">
          <input
            ...
            className="w-6 h-6"
          />
          <span className="text-gray-800 text-3xl">Mujer</span>
        </label>
      </div>
